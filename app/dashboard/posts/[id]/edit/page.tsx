...
export default function EditPostPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-medium text-gray-900">Edit Artikel</h1>
        <p className="text-sm text-gray-400 mt-0.5">Perbarui tulisan Anda</p>
      </div>
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-4 sm:p-6 space-y-5">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-2 border-t border-gray-50">
          <div className="flex items-center gap-2 order-2 sm:order-1">
            ...
            <span className="text-xs text-gray-400">{form.published ? "Terbit" : "Draf"}</span>
          </div>
          <div className="flex gap-3 order-1 sm:order-2">
            ...
            >
              {loading ? "Menyimpan..." : "Perbarui & Terbitkan"}
            </button>
          </div>
        </div>
      </div>
